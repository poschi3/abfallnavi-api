...
class FraktionenApi(object):
    ...
    def __init__(self, api_client=None):
        ...
        self.muellarten_endpoint = _Endpoint(
            settings={
                "response_type": ([Fraktion],),
                "auth": [],
                "endpoint_path": "/fraktionen",
                "operation_id": "muellarten",
                "http_method": "GET",
                "servers": None,
            },
            params_map={
        ...
        self.muellarten_pro_hausnummer_endpoint = _Endpoint(
            settings={
                "response_type": ([Fraktion],),
                "auth": [],
                "endpoint_path": "/hausnummern/{hausnummernId}/fraktionen",
                "operation_id": "muellarten_pro_hausnummer",
                "http_method": "GET",
                "servers": None,
            },
            params_map={
        ...
        self.muellarten_pro_strasse_endpoint = _Endpoint(
            settings={
                "response_type": ([Fraktion],),
                "auth": [],
                "endpoint_path": "/strassen/{strassenId}/fraktionen",
                "operation_id": "muellarten_pro_strasse",
                "http_method": "GET",
                "servers": None,
            },
            params_map={
    ...
    def muellarten(self, **kwargs):
        """Müllarten im System  # noqa: E501

        Welche Müllarten es im System gibt (z.B. Restabfall, Bioabfall, Papiertonne, Gelbe Tonne, Papiertonne 1100)  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True

        >>> thread = api.muellarten(async_req=True)
        >>> result = thread.get()
        ...
        return self.muellarten_endpoint.call_with_http_info(**kwargs)

    def muellarten_pro_hausnummer(self, hausnummern_id, **kwargs):
        """Müllarten für Hausnummer  # noqa: E501

        Welche Müllarten es an einer Hausnummer gibt. Siehe id unter Pfad `/strassen/{strassenId}` für die hausnummernId.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True

        >>> thread = api.muellarten_pro_hausnummer(hausnummern_id, async_req=True)
        >>> result = thread.get()
        ...
        return self.muellarten_pro_hausnummer_endpoint.call_with_http_info(**kwargs)

    def muellarten_pro_strasse(self, strassen_id, **kwargs):
        """Müllarten für Straßen  # noqa: E501

        Welche Müllarten es in einer Straße gibt. Siehe id unter Pfad `/orte/{ortId}/strassen` für die strassenId.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True

        >>> thread = api.muellarten_pro_strasse(strassen_id, async_req=True)
        >>> result = thread.get()
        ...
        return self.muellarten_pro_strasse_endpoint.call_with_http_info(**kwargs)
