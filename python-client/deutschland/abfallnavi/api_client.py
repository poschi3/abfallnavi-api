...
from deutschland.abfallnavi import rest
from deutschland.abfallnavi.configuration import Configuration
from deutschland.abfallnavi.exceptions import ApiException, ApiTypeError, ApiValueError
from deutschland.abfallnavi.model_utils import (
    ModelComposed,
    ModelNormal,
    ModelSimple,
...
class Endpoint(object):
    ...
    def __call__(self, *args, **kwargs):
        ...
        api_instance = AbholpunkteApi()
        api_instance.hausnummern_pro_strasse  # this is an instance of the class Endpoint
        api_instance.hausnummern_pro_strasse()  # this invokes api_instance.hausnummern_pro_strasse.__call__()
        which then invokes the callable functions stored in that endpoint at
        api_instance.hausnummern_pro_strasse.callable or self.callable in this class
