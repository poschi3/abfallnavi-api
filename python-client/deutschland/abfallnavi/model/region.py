...
class Region(ModelSimple):
    ...
    def __init__(self, *args, **kwargs):
        ...
        Args:
            args[0] (str): if omitted defaults to "nuernberg", must be one of ["aachen", "zew2", "aw-bgl2", "bav", "din", "dorsten", "gt2", "hlv", "coe", "krhs", "pi", "krwaf", "lindlar", "stl", "nds", "nuernberg", "roe", "wml2", ]  # noqa: E501

        Keyword Args:
            value (str): if omitted defaults to "nuernberg", must be one of ["aachen", "zew2", "aw-bgl2", "bav", "din", "dorsten", "gt2", "hlv", "coe", "krhs", "pi", "krwaf", "lindlar", "stl", "nds", "nuernberg", "roe", "wml2", ]  # noqa: E501
